...
import ScooterListComponent from '../components/ScooterListComponent';
import AddScooterComponent from '../components/AddScooterComponent';
import AddScooterListingComponent from '../components/AddScooterListingComponent';
        ...
        <div className='bg-blue-50 min-h-screen pb-16'>
            ...
            <>   
                ...
                <div className='flex flex-row w-5/6 mx-auto mt-16 items-center'>
                    {scooterListing && <AddScooterListingComponent jwt={jwt} scooterListing={scooterListing} setScooterListing={setScooterListing} setScooters={setScooters} scooters={scooters}/>}
                    {viewListing && <ScooterListingComponent jwt={jwt} viewListing={viewListing} setViewListing={setViewListing} setScooters={setScooters} scooters={scooters} />}
                </div>
            </>
            }
        </div>
